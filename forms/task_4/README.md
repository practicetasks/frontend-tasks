...
Первый заголовок расположите в самом начале зоны `form__input-container_ctrl_additional` с текстом «**Количество колонок**».
Второй заголовок с текстом «**Дополнительные параметры**» расположите в самом конце зоны `container_ctrl_additional`.

Оба заголовка сделайте элементом `form__heading`, добавьте модификатор `form__heading_type_ctrl-el-heading`. По этому
модификатору мы отличим заголовок секции от основного, расположенного в начале всей формы.
            ...
            <form class="form__admin">
                <div class="form__main-container">
                    ...
                    <fieldset class="form__input-container form__input-container_ctrl_texts">
                        ...
                        <input id="heading" type="text" class="form__item form__item_el_heading" name="heading">
                        ...
                        <textarea id="main-text" class="form__item form__item_el_main-text" name="main-text"></textarea>

                        <label for="email" class="form__label">E-mail</label>
                        <input id="email" type="email" class="form__item form__item_el_email" name="email">
                    ...
                    <fieldset class="form__input-container form__input-container_ctrl_visual">
                        ...
                        <select id="font-family" class="form__item form__item_el_font-family" name="font-family">
                            <option value="ibm">IBM Plex Serif</option>
                            <option value="ubuntu">Ubuntu</option>
                            <option value="istok">Istok Web</option>
                        </select>
                        ...
                        <input id="heading-font-size" type="number" class="form__item form__item_el_heading-fontsize"
                               name="heading-font-size" value="32">
                        ...
                        <input id="text-font-size" type="number" class="form__item form__item_el_text-fontsize"
                               name="text-font-size" value="24">

                        <label for="pub-date" class="form__label">Дата создания статьи</label>
                        <input id="pub-date" type="date" class="form__item form__item_el_pubdate" name="pub-date">

                        <label for="image" class="form__label">Обложка статьи</label>
                        <select id="image" class="form__item form__item_el_image" name="image">
                            <option value="bombardier">Bombardier CS300</option>
                            <option value="hobbit">Боинг-777 Хоббит</option>
                            <option value="tiger">Тигролёт</option>
                            <option value="connected">Connected to 01000010 01001100 01010101 01000101</option>
                        </select>
                    </fieldset>
        ...
        <div class="content__container">
            ...
            <div class="content__text">
                <p class="content__paragraph">
                    ...
                    индивидуальность, ливрею заказали живописцу. При условии, что эскиз он выполнит в одиночку и лично
                ...
                <p class="content__paragraph">
                    ...
                    доброжелательность и свободу. Заказ был выполнен в рекордный срок, всего за 5 месяцев. Самолёт
                ...
                <p class="content__paragraph">
                    ...
                    аэропортах Парижа, Валенсии, Кракова, Берлина, Вены, Загреба, на Майорке, Крите и Сицилии. Самолёт
